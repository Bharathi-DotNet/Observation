        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EmpId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    IdentityNo = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BDA = table.Column<int>(type: "int", nullable: true),
                    PaymentRemarks = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    EnquiryDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    AppoinmentDate = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    CreatedBy = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    UpdatedBy = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Clients", x => x.EnquiryId);
                    table.ForeignKey(
                        name: "FK_Clients_Employees_BDA",
                        column: x => x.BDA,
                        principalTable: "Employees",
                        principalColumn: "EmpId");
                    table.ForeignKey(
                        name: "FK_Clients_Employees_TechExpert",
                        column: x => x.TechExpert,
                        principalTable: "Employees",
                        principalColumn: "EmpId");
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_History_Clients_EnquiryId",
                        column: x => x.EnquiryId,
                        principalTable: "Clients",
                        principalColumn: "EnquiryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_History_Employees_EmpId",
                        column: x => x.EmpId,
                        principalTable: "Employees",
                        principalColumn: "EmpId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Department",
                columns: new[] { "DeptId", "DeptName", "IsActive" },
                values: new object[,]
                {
                    { 1, "BDA", true },
                    { 2, "Tech", true },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_History_EmpId",
                table: "History",
                column: "EmpId");

            migrationBuilder.CreateIndex(
                name: "IX_History_EnquiryId",
                table: "History",
                column: "EnquiryId");
        }
