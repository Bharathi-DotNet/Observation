...
namespace Enquiry.Web.Migrations
{
    ...
    [Migration("20230325070801_phaseHistory")]
    partial class phaseHistory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Enquiry.Web.Models.Clients", b =>
                {
                    ...
                    b.Property<int>("PreviousEnquiryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Enquiry.Web.Models.JournalStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Enquiry.Web.Models.Phase", b =>
                {
                    ...
                    b.Property<DateTime?>("DemoDate1")
                        .HasColumnType("datetime(6)");

                    b.Property<DateTime?>("DemoDate2")
                        .HasColumnType("datetime(6)");

                    b.Property<DateTime?>("DemoDate3")
                        .HasColumnType("datetime(6)");
                    ...
                    b.Property<int?>("TechExpert1")
                        .HasColumnType("int");

                    b.Property<int?>("TechExpert2")
                        .HasColumnType("int");

                    b.HasKey("PhaseId");

                    b.HasIndex("Programmer");
                    ...
                    b.HasIndex("TechExpert1");

                    b.HasIndex("TechExpert2");

                    b.ToTable("Phase");
                });

            modelBuilder.Entity("Enquiry.Web.Models.PhaseHistory", b =>
                {
                    b.Property<int>("HistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Enquiry.Web.Models.Publication", b =>
                {
            ...
            modelBuilder.Entity("Enquiry.Web.Models.Visitors", b =>
                {
            ...
            modelBuilder.Entity("Enquiry.Web.Models.WorkStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            WorkStatusId = 6,
                            IsActive = true,
                            WorkStatusName = "Accepted"
                        },
                        new
                        {
                            WorkStatusId = 7,
                            IsActive = true,
                            WorkStatusName = "Rejected"
                        },
                        new
                        {
                            WorkStatusId = 8,
            ...
            modelBuilder.Entity("Enquiry.Web.Models.Phase", b =>
                {
                    b.HasOne("Enquiry.Web.Models.Employees", "Employees3")
                        .WithMany()
                        .HasForeignKey("Programmer");
                    ...
                    b.HasOne("Enquiry.Web.Models.Employees", "Employees1")
                        .WithMany()
                        .HasForeignKey("TechExpert1");

                    b.HasOne("Enquiry.Web.Models.Employees", "Employees2")
                        .WithMany()
                        .HasForeignKey("TechExpert2");
            ...
            modelBuilder.Entity("Enquiry.Web.Models.PhaseHistory", b =>
                {
                    ...
                    b.HasOne("Enquiry.Web.Models.Phase", "Phase")
            ...
            modelBuilder.Entity("Enquiry.Web.Models.Publication", b =>
                {
                    ...
                    b.HasOne("Enquiry.Web.Models.JournalStatus", "JournalStatus")
                        .WithMany()
                        .HasForeignKey("Status")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
